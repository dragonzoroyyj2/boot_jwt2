...
import com.mybaselink.app.service.SimilarStockService;

@RestController
@RequestMapping("/api/krx")
public class SimilarStockController {

    private final SimilarStockService service;

    // ✅ 수동 생성자 주입 (Lombok 사용 안 함)
    public SimilarStockController(SimilarStockService service) {
        this.service = service;
    }

    @GetMapping("/similar-advanced_succ")
